...
一个完整的、可运行的 Arma 3 与 ROS 集成系统，用于群体无人机路径规划。本项目将 Arma 3 游戏引擎作为高保真仿真环境，与 ROS 中的 EGO-Planner-v2 路径规划算法集成，并可选集成 **ARK Robotics 框架**以增强机器学习能力，实现多无人机的自主协调飞行。
